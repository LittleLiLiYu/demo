...
public class HttpClientUtils1 {
    private static Logger logger = LoggerFactory.getLogger(HttpClientUtils1.class);
    ...
    public static String sendSSLPostRequest3(String reqURL, Map<String, String> params, int timeout) {
        // 响应内容
...
//            params.put("itemId", "8658762");
//            params.put("itemTitle", "Java调用https接口，避免证书的方式");
            params.put("jid", "admin@10.25.0.188");
            params.put("type", "xml");
//            String result = HttpClientUtils1.sendSSLPostRequest3("https://recomm.cnblogs.com/api/v1/recomm/blogpost/reco", params, 3000);
            String result = HttpClientUtils1.sendSSLPostRequest3("https://10.25.0.188:9091/plugins/presence/status", params, 3000);
//            String result = RequestUtil.doGet("https://10.25.0.188:9091/plugins/presence/status?jid=admin@10.25.0.188&type=xml");
